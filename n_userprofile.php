...
$stmt = $conn->prepare("SELECT usersName,usersCountry, usersAddress, usersPcode, usersEmail, usersCnum ,brandName, brandType, brandColour, brandStorage, orderedDate FROM orders WHERE userUid = ?");
    ...
    <?php if (!empty($orders)): ?>
                ...
                <div class="box-container_order">
                    <div class="box_order">
                        ...
                        <ul class="o">
                            <li><?php echo "<p>Brand  : ".htmlspecialchars($order['brandName'])."</p>"; ?></li>
