...
function sendOrder($conn, $fullName, $country, $address, $pcode, $email, $cnum,$phoneType,$date,$userId){
    $orderstatus = 'pending';
    $sql = "INSERT INTO orders (usersName,usersCountry, usersAddress, usersPcode, usersEmail, usersCnum , brandType,orderedDate,userUid,status) VALUES (?,?, ?, ?, ?, ?, ?, ?, ?, ?);";
